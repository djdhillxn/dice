...
def annotate_video(video_path, metrics_path, output_path):
    ...
    capture.release()
    writer.release()
    print("[DICE] Saved annotated video:", output_path.resolve())
...
if __name__ == "__main__":
    ...
    annotate_video(args.video, args.metrics, args.output)
